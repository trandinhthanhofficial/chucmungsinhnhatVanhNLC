const contentLetterSrart_actived =
  "Bắt đầu từ ngày hôm nay bạn đã bước sang một tuổi mới rồi đấy, cho dù có là một ngày như thế nào đi chăng nữa thì cũng đừng quên hôm nay là sinh nhật của bạn"; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Là một ngày rất ý nghĩa đối với bạn, bọn ni chúc bạn có một tuổi mới mạnh khỏe, bình an, hạnh phúc và sẽ đạt được những thành quả tuyệt vời vì chúng đã xứng đáng với tất cả những nỗ lực của bạn. Chúc mừng sinh nhật bạn Vanh NLC cảm ơn vì đã đến."; //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/team2.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/team2.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
